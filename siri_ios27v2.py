...
class SiriIOS27(QWidget):
    ...
    def initUI(self):
        self.siri_attivato = False
        self.setWindowTitle('Siri')
        self.resize(480, 720)
        ...
        self.chat_area.append("<span style='color: #00f2fe; font-weight: bold;'>Siri:</span> Hi, ask me something.")
...
# --- GRAFICA PAGINA IMPOSTAZIONI ---
        ...
        if tema_salvato == "Dark":
            self.chat_page.setStyleSheet("background-color: rgba(0, 160, 220, 0.45); border-radius: 22px;")
            self.settings_page.setStyleSheet("background-color: rgba(0, 160, 220, 0.45); border-radius: 22px;")
...
Siri() {
    ...
    while true; do
        ...
        if [ -z "$frase_utente" ]; then
            ...
            if [ "$conferma_prop" = "yes" ] || [ "$conferma_prop" = "yap" ]; then
                ...
                case "$index" in
                    ...
                    8) echo "Siri: Type the word 'kernel' in the chat.";;
        ...
        case "$pulita" in
           *"What I can do with u"*|*"what i can do with you"*|*"what can you do"*)
                echo "You can check the weather, open a directory file, teach me commands, tech me something to say, find a idea with the thunderbolt button and more... I'm not an AI then I can't start a conversation."
           *"good afternoon"*|*"good morning"*|*"good evening"*|*"hey"*|*"hey siri"*|*"hi"*|*"hello"*)
            ...
            *"fine"*|*"all right"*|*"all good"*|*"normal"*)
                ...
                ;;
            *"angry"*)
                echo "Siri: Oh pleasee don't hurt me! Can I help yo with something to be happy or someone else? >_<"
            ...
            *"battery"*)
                ...
                ;;
            *"weather"*)
                echo "If you don't done it, I ask to you to tell me the name of your city to have better results."
